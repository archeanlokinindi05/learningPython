...
if "--benchmark" in sys.argv:
    ...
    print(len(program))
    print("bytes")
    print(len(list(tokenize(program))))
    print("tokens")
    ...
    print(bench("built-in compile", lambda program: compile(program, "", "eval")))
    print(bench("parser.parse", lambda program: parser.st2tuple(parser.expr(program))))

    print(bench("compiler.parse", lambda program: compiler.parse(program, "eval")))
    print(bench("compiler.compile", lambda program: compiler.compile(program, "", "eval")))
